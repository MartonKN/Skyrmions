function initializeGPE__Lobe_peak(filenameBase)
...
% V0=(V11+V22)/2. (And consequently time will be measured in units of 1/V0.)
    ...
    SysParams__Mx=32;                           % number of points in each direction of the grid
    SysParams__My=32;   
    SysParams__Mz=32; 
    ...
    SysParams__az=1.0;
    SysParams__tmax=1.0;                        % maximal imaginary time and imaginary time step of the simulation
    SysParams__dt=0.001;                        % (the latter will be reset anyway in the program)
    
    % Parameters of the action
    SysParams__T=0.05;                          % temperature
    SysParams__V0=1.0;                          % interaction terms
    SysParams__V2=0.025;
    SysParams__J=0.4/6;                         % hopping
    SysParams__mu_0=0.30;                       % chemical potentials in the middle of the trap
    SysParams__trapx=0.40/((SysParams__Mx-1)/2)^2;
    SysParams__trapy=0.40/((SysParams__My-1)/2)^2;
    SysParams__trapz=0.40/((SysParams__Mz-1)/2)^2;
